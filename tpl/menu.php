...
<div class="navbar navbar-fixed-top">
    ...
    <marquee style="margin-top: 0.7%;">Зарлалууд</marquee>
    </div>
  <div class="navbar navbar-default" id="2" style="margin-top: 0px;">
    <div class="navbar-inner">
    <a class="brand" href="#">Surgalt.INFO</a>
    <ul class="nav navbar-nav">
        ...
        <li><a href="?host=credit.surgalt.info"><span class="ext tv"></span>Цагийн тооцоо</a></li>
      </ul>
    <button id="btn" class="btn btn-default" style="position: absolute; margin-left: 35%; margin-top: 0.5%"><span class="glyphicon-book"></span>Sw10d219@csms.edu.mn</button>
    <div id="Settings" style="display: none; width: 450px;">
        <div>
            <img src="../img/avatar.jpg" class="img-polaroid"><br>
...
<!--<header class="navbar navbar-fixed-top" role="banner">
    ...
    <div class="navbar-header">
      <button class="navbar-toggle" type="button" data-toggle="collapse" data-target=".bs-navbar-collapse">
        ...
        <button id="btn" class="btn btn-default" style="position: absolute; margin-left: 60%; margin-top: 1%"><span class="glyphicon-book"></span>Sw10d219@csms.edu.mn</button>
  </div>
<div id="Settings" style="display: none; width: 500px;">
  ...
  <div class="container">     
    <div class="navbar-header">
      ...
      <a href="./" class="navbar-brand">Surgalt.INFO</a>
    </div>
    <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
      <ul class="nav navbar-nav">
        ...
        <li><a href="?host=grades.surgalt.info"><span class="ext mobi"></span>Журнал</a></li>
        <li><a href="?host=calendar.surgalt.info"><span class="ext co"></span>Цаглабар</a></li>
        <li><a href="?host=credit.surgalt.info"><span class="ext tv"></span>Цагийн тооцоо<i class="icon-remove"></i></a></li>
      </ul>
    </nav>
  </div>
